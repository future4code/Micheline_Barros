...
app.listen(3003, () => {
    console.log("Server is running in door 3003")
}) //essa linha faz o servidor escutar a porta 3003, poderia ser 5500(live server), 3001, 3333 (obs.: a porta 3000 já é utilizada pelo react) / o console.log serve pra avisar quando o processo já está ancorado na porta e que já pode testar os endpoint.